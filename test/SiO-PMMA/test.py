...
from pipeline import run_sdf_mode, topology_builder
...
body_configs = {
    ...
    0: {
        'file': 'POSS.pdb',
        'mapping': {
            5: {'atom_index': [0, 32, 33], 'smarts': '[N:1]([H:2])[H:3]'},
            # the key is local CG bead index, the value is local atom index
...
aa_mols = run_sdf_mode(mol_config, reaction_template, xmlfile, rigid_configs=body_configs, reactions=None, large=200,
                       chunks_per_d=1, output_sdf_path='POSS-g-PMMA_aa.sdf')
